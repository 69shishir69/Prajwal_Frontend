...
import 'package:hospital_management_system/models/book_vehicle_appointment.dart';
import 'package:hospital_management_system/models/companyModel.dart';
import 'package:hospital_management_system/models/vehicle_category.dart';
import 'package:hospital_management_system/models/vehicleModel.dart';
...
import 'package:hospital_management_system/response/doctor_appointment/company_appointment_response.dart';
import 'package:hospital_management_system/response/doctor_appointment/vehicle_appointment_response_data.dart';
import 'package:hospital_management_system/response/doctor_appointment/get_vehicle_appointment_response.dart';
import 'package:hospital_management_system/response/doctor_appointment/vehicle_appointment_response.dart';
import 'package:hospital_management_system/response/doctor_ui_appointment/company_ui_appointment.dart';
import 'package:hospital_management_system/response/doctor_ui_appointment/get_company_ui_appointment.dart';
import 'package:hospital_management_system/response/vehicle_category_id.dart';
import 'package:hospital_management_system/response/vehicle_category_response.dart';
...
class CategoryAPI {
  ...
  Future<VehicleCategory?> getvehicleCategoryId(String name) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        VehicleCategoryId healthCategoryId =
            VehicleCategoryId.fromJson(response.data);

        healthCategory = VehicleCategory.fromJson(healthCategoryId.data);
      }
    } catch (e) {
      debugPrint("Error: ${e.toString()}");
    }
