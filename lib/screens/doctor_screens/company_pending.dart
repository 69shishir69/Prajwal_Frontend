...
class CompanyPendingPage extends StatefulWidget {
  const CompanyPendingPage({Key? key}) : super(key: key);

  @override
  State<CompanyPendingPage> createState() => _CompanyPendingPageState();
}

class _CompanyPendingPageState extends State<CompanyPendingPage> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                FutureBuilder<List<GetCompanyUIAppointment?>>(
                  future:
                      CategoryRepository().getCompanyUIAppointment("Pending"),
  ...
  acceptAppointment(GetCompanyUIAppointment appointmentResponse) async {
    debugPrint("Appointment ID: " + appointmentResponse.id!);
    bool isAccepted = await CategoryRepository()
        .updateCompanyUIAppointment(appointmentResponse.id!, "Accepted");
    if (isAccepted) {
